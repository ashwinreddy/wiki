**Maxwell's equations** describe how to create [[electric field]] $\vec{E}$ and magnetic field $\vec{B}$ using an electric charge density $\rho$ and current vector $\vec{\jmath}$. They describe classical electromagnetism.
