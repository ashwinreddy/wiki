...
$$
\begin{cases}  |1(-1)\rangle = \mid \downarrow\downarrow \rangle \\\\ |10\rangle = \frac{1}{\sqrt{2}}\left(\mid \uparrow\downarrow  \rangle+\mid \downarrow \uparrow \rangle\right) \end{cases}
$$
