...
Fortunately, we can solve the infinite square well. Outside the well, $\psi(x) = 0$. Inside the well, $V=0$ and the [[Schrodinger equation#time-independent-schrodinger-equation]] says
