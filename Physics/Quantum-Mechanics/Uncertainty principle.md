...
The uncertainty principle is only interesting when the observables do not commute. If $\left[A, B \right] = 0$, we have no information.
...
$$
\sigma_x^2 \sigma_p^2 \geq \left(\frac{1}{2\iota} \iota \hbar \right)^2
$$
