...
If $A$ and $B$ have zero [[commutator]], i.e. $\left[A, B\right]=0$, then the uncertainty principle is trivially true; all it says is that the product of variances is non-negative. When the observables do not commute, they cannot have a complete set of common eigenfunctions, they can't have [[compatibility of observables]].
