...
> If it is true that predators were the primary selective pressure operating on mammals to favor this initial expansion of the LGN visual system, then we should expect some degree of coordinated timing between when the predator appeared and when the mammalian LGN visual system appeared, i.e., sometime before placental mammals and amrsupials diverged. If it is true that snakes, in particular, were the responsible preadtors, then we should expect them to have originated around that same time. 
