...
The associativity $N$ tells us how many sets there are for each block. So the more associative a cache, the more permissive the cache is. A fully associative cache will allow data to be stored in any cache block and will have no need for any index.
