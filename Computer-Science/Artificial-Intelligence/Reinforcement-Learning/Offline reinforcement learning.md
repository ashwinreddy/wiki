...
**Offline reinforcement learning** (sometimes known as batch RL) is reinforcement learning using only a static dataset $\mathcal{D} = \\{(s, a, s', r)_j\\}$ of experience without being able to try anything online.
