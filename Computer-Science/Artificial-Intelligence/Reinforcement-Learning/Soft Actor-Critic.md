...
$$
\max_\theta \mathbb{E}_{s \sim \mathcal{D}, \xi \sim \mathcal{N}}\left[ \min_j Q_{\phi_j}(s, \tilde{a}\_\theta(s, \xi)) - \alpha \log \pi\_\theta \left( \tilde{a}_\theta(s, \xi) \mid s \right) \right] \tag{policy improvement}
$$
