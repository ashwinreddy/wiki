...
**Advantage weighted actor critic (AWAC)** is an [[actor-critic]] algorithm designed to handle a buffer $\beta$ of any kind of experience: demonstrations, suboptimal data, random exploration data, introduced in @nair2020accelerating. This lets us do [[offline reinforcement learning]] and then online fine-tuning.
