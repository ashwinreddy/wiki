...
**Advantage weighted actor critic (AWAC)** [@nair2020accelerating] is an [[actor-critic]] algorithm designed to handle a buffer $\beta$ of any kind of experience: demonstrations, suboptimal data, random exploration data. This lets us do [[offline RL|offline reinforcement learning]] and then online fine-tuning.
