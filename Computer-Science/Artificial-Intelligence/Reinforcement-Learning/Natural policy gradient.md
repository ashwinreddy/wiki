...
[[Newton's method]] provides a way to optimize this, and it requires the derivative and a metric or a [[Hessian]]. The question is which metric or Hessian to use. The derivative or [[gradient]] is straightforward.
