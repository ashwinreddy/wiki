...
3. The cooperative strategy is to play the pure strategies $x = e_{i_\*}$ and $y=e_{j_*}$. The payoff vector is $(a_\*, b_*) = \left(\frac{\sigma+\delta}{2},\frac{\sigma - \delta}{2}\right)$. 
