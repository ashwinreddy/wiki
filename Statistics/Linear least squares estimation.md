...
<<Warn("Before you use this formula, check to see if the MMSE is already linear!")>>
...
\begin{align}
\mathbb{E}\left[Y - L\left[Y \mid X\right]\right] = 0, \tag{Unbiased} \\\\
\mathbb{E}\left[\left(Y - L\left[Y \mid X\right]\right)X\right] = 0,
\end{align}
