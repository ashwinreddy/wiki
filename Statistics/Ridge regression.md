**Ridge regression** is an extension of [[ordinary least squares]] [[linear regression]] that puts an [[Euclidean norm]]. If the [[design matrix]] is $X \in \mathbb{R}^{n \times d}$ and $y \in \mathbb{R}^{n}$,
