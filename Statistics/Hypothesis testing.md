...
We pick a significance level of 5%. In other words, we will reject the hypothesis that the coin is unbiased if there's a less than 5% of getting the results that we do. Note that $\frac{H - 50}{\sqrt{5}} \sim \mathcal{N}(0, 1)$
