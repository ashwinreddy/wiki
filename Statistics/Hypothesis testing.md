...
Since the flips are modeled as a [[binomial distribution]] with $p = q = \frac{1}{2}$ and $n=100$ with the [[central limit theorem]] allowing us to approximate with a [[normal distribution]] $\mathcal{N}(np, \sqrt{npq} )$, we can say that
