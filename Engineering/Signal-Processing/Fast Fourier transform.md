...
In particular, it is useful for [[polynomial]] multiplication. Suppose we have a coefficient representation $[p_0, \dots, p_{n-1}]$. The FFT will give us a value representation
