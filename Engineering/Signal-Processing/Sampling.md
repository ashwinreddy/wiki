...
These samples $\\{ x(nT) \\}$ for $n \in \mathbb{Z}$ make up a discrete-time signal $x_d[n]$. This discrete time signal can actually be represented as a train of [[Dirac delta]] in continuous space, if needed:
