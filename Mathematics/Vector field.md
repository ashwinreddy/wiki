A **vector field** $F$ assigns vectors to points on a [[manifold]].

# Formal construction

A vector field on a [[manifold]] $M$ maps points on $M$ to [[tangent vectors|tangent vector]]. This defines the signature as manifold to tangent bundle.
