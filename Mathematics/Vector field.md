A **vector field** is a [[tensor field]] assigning to manifold $M$ [[vectors|vector]], in fact [[tangent vectors|tangent vector]]. Suppose $p \in M$ is a point on a a manifold $M$. Then the vector field $X$ is such that
