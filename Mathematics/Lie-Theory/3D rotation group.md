The **3D rotation group** _SO(3)_ represents rotations in $\RR^3$. It is the [[special orthogonal group]] in 3D, the [[Lie group]] of rotations in three-dimensions. It consists of matrices $O$ such that $O^\mathsf{T}O = I$ and $\det O = 1$
