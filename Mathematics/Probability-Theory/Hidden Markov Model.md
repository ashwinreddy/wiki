A **Hidden Markov model (HMM)** is a [[Markov model]] models a [[sequence]] $Q = \left(q_i\right)_{i=0}^T$ of hidden states  and observation sequence $O=\left(o\_i\right)_{i=1}^T$.
