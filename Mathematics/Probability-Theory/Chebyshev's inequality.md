...
&= \mathbb{E}\left[(X - \mu)^2 \mid k\sigma \leqslant |X - \mu| \right] \mathbb{P}\left(k \sigma \leqslant |X - \mu|\right) + \mathbb{E}\left[(X - \mu)^2 \mid k\sigma > |X - \mu| \right] \mathbb{P}\left(k \sigma > |X - \mu|\right)
\end{align}