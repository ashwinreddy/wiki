A **random variable (RV / r.v. / R.V.)** assigns a [[real number]] to every outcome in the sample space for [[probability space]] $(\Omega, \mathcal{F}, \mathbb{P})$. Formally, we write it as a [[function]] $X: \Omega \to \RR$.
