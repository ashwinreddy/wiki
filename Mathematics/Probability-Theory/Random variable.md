A **random variable (RV / r.v. / R.V.)** assigns a [[real number]] to every sample in a [[probability space]] $(\Omega, \mathcal{F}, \mathbb{P})$. Formally, we write it as a [[function]] $X: \Omega \to \RR$.
