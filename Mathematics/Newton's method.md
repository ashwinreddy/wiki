...
The equation readily generalizes to higher dimensions if we let $f''$ represent the [[Hessian]]. Computationally, this requires us to compute the [[inverse matrix|invertible matrix]].


You'll notice that standard [[gradient descent]] corresponds here under the assumption that the Hessian is identity.