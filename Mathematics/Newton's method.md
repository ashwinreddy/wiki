...
The equation readily generalizes to higher dimensions if we let $f''$ represent the [[Hessian]]. You'll notice that standard [[gradient descent]] corresponds here under the assumption that the Hessian is identity.