**Gradient descent** is an iterative optimization algorithm for finding the minimum of a multivariable function $F(x)$. Repeat the following step until convergence:
