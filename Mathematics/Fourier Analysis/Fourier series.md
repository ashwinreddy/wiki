The **Fourier series** is a [[series]] decomposition of a [[periodic signal|periodic function]] $f(t)$ with fundamental period $T$ using a [[linear combination]] of fixed frequency waves. In other words, we posit that all of the following formulations make sense for any sufficiently nice $x(t)$.
