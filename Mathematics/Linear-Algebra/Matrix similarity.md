...
Similar matrices have the same eigenvalues. Suppose $\lambda$ is an eigenvalue for $A$, meaning $Ax = \lambda x$. Now we substitute $A \mapsto P^{-1}BP$ and left-multiply by $P$:
