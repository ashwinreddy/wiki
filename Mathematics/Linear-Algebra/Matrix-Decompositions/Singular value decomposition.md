...
\begin{align\*}
\mathbf{A} &= \overbrace{\mathbf{U}}^{\textbf{left singular vectors}} \overbrace{\mathbf{\Sigma}}^{\text{singular values}} &\mathbf{\underbrace{V}_{\text{right singular vectors}}}^{\mathsf{T}} \\\\
