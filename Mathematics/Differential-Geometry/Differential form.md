...
A **differential form** is, roughly speaking, an object that we can integrate. Recall that an integral is computing the accumulation of some value over a path. Then, operationally,
