For a [[differentiable manifold]] $M$, the tangent space $T_pM$ is a [[vector space]] copy of $\RR^n$ tangential to $M$ at $p$. A smooth curve $\gamma$ passing through $p$ will have a derivative vector that belongs to $T_p M$.
